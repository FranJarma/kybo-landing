...
const bubbleWaffles = [
  {
    ...
    description:
      "Masa de choco oreo, servido con Nutella, frutas frescas y bañado con crema chantilly (totalmente sacado)",
  ...
  },
  {
    name: "Dos, please",
    description:
      "Masa común o de chipa, huevo y palta con un toque de pimienta negra y aceite de oliva (locura total)",
...
export function BubbleWaffles() {
  return (
    <section id="bubble-waffles" className="bg-kybo-blue/5 w-full py-18 md:py-24">
