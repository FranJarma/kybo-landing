...
export function Hero() {
  return (
    <section id="hero" className="relative h-screen overflow-hidden bg-kybo-blue">
      ...
      <div className="relative flex flex-col items-center justify-between h-full px-4 mt-10 md:mt-0 md:flex-row md:gap-40 md:px-6">
        <div className="max-w-4xl space-y-6 text-left text-white">
          ...
          <div className="flex flex-col gap-4 items-center sm:flex-row sm:justify-center md:justify-start">
            <Button size="lg" className="w-full text-center bg-kybo-orange hover:bg-kybo-orange/90 text-white text-lg" asChild>
              <Link target="_blank" href="https://menu.fu.do/kybo">Ver Menú</Link>
            </Button>
            <Button size="lg" variant="outline" className="text-lg w-full text-cente border-[#ff8000] text-kybo-orange" asChild>
